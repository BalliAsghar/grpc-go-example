...
func (c *productServiceClient) GetProductList(ctx context.Context, in *ProductListRequest, opts ...grpc.CallOption) (*ProductList, error) {
	out := new(ProductList)
...
func (UnimplementedProductServiceServer) GetProductList(context.Context, *ProductListRequest) (*ProductList, error) {
